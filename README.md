...
1. **Bronze Layer**: Stores raw data as-is from the source systems (.cvs Files) into SQL Server Database.
...
3. **Data Modeling**: Developing fact and dimension tables optimized for analytical queries using the star schema.
---
